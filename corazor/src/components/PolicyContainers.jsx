    ...
    <div className='w-full bg-[#111315] flex flex-col justify-center items-center py-5'>
      <div className='w-[50%] flex flex-col justify-center items-center'>
        <div className='flex justify-around w-full mb-5'>
          <button className='text-white py-2 px-4 rounded-lg bg-blue-500 hover:bg-blue-700' onClick={() => setCurrentPolicy('terms')}>
            Terms
          </button>
          <button className='text-white py-2 px-4 rounded-lg bg-blue-500 hover:bg-blue-700' onClick={() => setCurrentPolicy('refund')}>
            Refund Policy
          </button>
          <button className='text-white py-2 px-4 rounded-lg bg-blue-500 hover:bg-blue-700' onClick={() => setCurrentPolicy('privacy')}>
            Privacy Policy
          </button>
        </div>
...
const Terms = () => {
  return (
    <div>
      <h2 className='text-center text-3xl text-[#f8f9fa] font-bold mb-5'>Terms and Conditions</h2>
      ...
      <h3 className='text-center text-2xl text-[#f8f9fa] font-bold mb-3'>Services Offered</h3>
      ...
      <h3 className='text-center text-2xl text-[#f8f9fa] font-bold mb-3'>User Accounts</h3>
      <p className='max-w-[80%] text-center mb-5 text-[#6c757d] text-bold'>
      ...
      <h3 className='text-center text-2xl text-[#f8f9fa] font-bold mb-3'>Intellectual Property</h3>
      <p className='max-w-[80%] text-center mb-5 text-[#6c757d] text-bold'>
      ...
      <h3 className='text-center text-2xl text-[#f8f9fa] font-bold mb-3'>Payment</h3>
      <p className='max-w-[80%] text-center mb-5 text-[#6c757d] text-bold'>
      ...
      <h3 className='text-center text-2xl text-[#f8f9fa] font-bold mb-3'>Termination, Limitation of Liability, Governing Law</h3>
      <p className='max-w-[80%] text-center mb-5 text-[#6c757d] text-bold'>
...
const RefundPolicy = () => {
  return (
    <div>
      <h2 className='text-center text-3xl text-[#f8f9fa] font-bold mb-5'>Refund Policy for Corazor Technology Private Limited</h2>
      <p className='max-w-[80%] text-[#6c757d] text-bold text-center mb-5'>
        Introduction
        We strive to ensure satisfaction with our Services. This Refund Policy outlines the
        circumstances under which refunds may be granted.
      </p>
      <h3 className='text-center text-3xl text-[#f8f9fa] font-bold mb-5'>Eligibility for Refund</h3>
      <p className='max-w-[80%] text-center mb-5 text-[#6c757d] text-bold'>
        Refunds are considered on a case-by-case basis for services that have not been delivered
        as promised, subject to the terms of the service agreement.
      </p>
      <h3 className='text-center text-3xl text-[#f8f9fa] font-bold mb-5'>Request Process</h3>
      <p className='max-w-[80%] text-center mb-5 text-[#6c757d] text-bold'>
        Requests for refunds should be submitted in writing to our customer service department,
        detailing the reason for the request.
      </p>
      <h3 className='text-center text-3xl text-[#f8f9fa] font-bold mb-5'>Processing Refunds</h3>
      <p className='max-w-[80%] text-center mb-5 text-[#6c757d] text-bold'>
        Eligible refunds will be processed within a reasonable timeframe, typically 30 days.
      </p>
      <h3 className='text-center text-3xl text-[#f8f9fa] font-bold mb-5'>Limitations</h3>
      <p className='max-w-[80%] text-center mb-5 text-[#6c757d] text-bold'>
        Refunds are not available for services already rendered or for minor issues that do not
        materially affect the overall provision of services.
      </p>
    </div>
  );
};
...
const PrivacyPolicy = () => {
  return (
    <div>
      <h2 className='text-center text-3xl text-[#f8f9fa] font-bold mb-5'>Privacy Policy for Corazor Technology Private Limited</h2>
      <p className='max-w-[80%] text-[#6c757d] text-bold text-center mb-5'>
